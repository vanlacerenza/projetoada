...
// Para capturar o que o usuário escrever, existe a função Scanf,
 //também do pacote fmt. Ela recebe dois argumentos, um modificador
	//(o que queremos receber como entrada, um inteiro, string, etc)
	 //e um ponteiro para a variável que guardará a entrada do usuário.
	 // E agora nós passamos para a função Scanf o valor "%d"
	 //Daqui a pouco falaremos sobre o &, que se encontra à frente da variável comando.
	 // Ou seja, a função salvará na variável o que o usuário digitar.
	 // E para verificar se a entrada está mesmo sendo salva na variável comando,
	 // vamos imprimi-la:
